...
const ccHeroSize = { width: 2175, height: 1455 }
const ccImageSizes: Record<string, { width: number; height: number }> = {
  'cc_slide_1.png': { width: 1868, height: 1358 },
  'cc_slide_2.png': { width: 2000, height: 1156 },
  'cc_slide_3.png': { width: 2016, height: 1372 },
  'cc_slide_4.png': { width: 2112, height: 1424 },
  'cc_slide_5.avif': { width: 1936, height: 1296 },
  'cc_slide_6.png': { width: 1928, height: 1352 },
  'cc_slide_7.png': { width: 1760, height: 1406 },
}
      ...
      <div className="container" style={{ marginBottom: '4rem' }}>
        <div className="img-hero-wrap">
          <img
            ...
            loading="lazy"
            width={ccHeroSize.width}
            height={ccHeroSize.height}
          />
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="cs-section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginTop: '1.5rem' }}>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_1.png" loading="lazy" width={ccImageSizes['cc_slide_1.png'].width} height={ccImageSizes['cc_slide_1.png'].height} alt="CreditConnection dashboard screen 1" /></div>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_2.png" loading="lazy" width={ccImageSizes['cc_slide_2.png'].width} height={ccImageSizes['cc_slide_2.png'].height} alt="CreditConnection dashboard screen 2" /></div>
            <div className="img-panel img-panel--flush" style={{ gridColumn: 'span 2' }}><img src="/assets/credit-connection/cc_slide_4.png" loading="lazy" width={ccImageSizes['cc_slide_4.png'].width} height={ccImageSizes['cc_slide_4.png'].height} alt="CreditConnection desktop dashboard" /></div>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_3.png" loading="lazy" width={ccImageSizes['cc_slide_3.png'].width} height={ccImageSizes['cc_slide_3.png'].height} alt="CreditConnection screen 3" /></div>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_5.avif" loading="lazy" width={ccImageSizes['cc_slide_5.avif'].width} height={ccImageSizes['cc_slide_5.avif'].height} alt="CreditConnection screen 5" /></div>
          </div>
        </div>
        ...
        <div className="cs-section" style={{ marginBottom: '6rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginTop: '2rem' }}>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_6.png" loading="lazy" width={ccImageSizes['cc_slide_6.png'].width} height={ccImageSizes['cc_slide_6.png'].height} alt="CreditConnection final screen 1" /></div>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_7.png" loading="lazy" width={ccImageSizes['cc_slide_7.png'].width} height={ccImageSizes['cc_slide_7.png'].height} alt="CreditConnection final screen 2" /></div>
            <div className="img-panel img-panel--flush"><img src="/assets/credit-connection/cc_slide_2.png" loading="lazy" width={ccImageSizes['cc_slide_2.png'].width} height={ccImageSizes['cc_slide_2.png'].height} alt="CreditConnection final screen 3" /></div>
          </div>
