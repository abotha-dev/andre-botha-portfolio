      ...
      <div className="container" style={{ marginBottom: '4rem' }}>
        <div style={{
          ...
          <div>
            ...
            <h3 style={{ fontSize: '1.15rem', fontWeight: 600, color: 'var(--text)', marginBottom: '0.4rem' }}>60+ screens. Full agentic flow.</h3>
      ...
      <div className="container">
        ...
        <div className="cs-section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem', marginTop: '1.5rem' }}>
            {[
              { stat: '60+', label: 'Screens designed across onboarding, triage, provider matching, insurance, and booking flows' },
              { stat: '5 → 1', label: 'Replaced five fragmented healthcare portals with a single conversational AI agent' },
              { stat: '13%', label: 'Improvement in nurse productivity by automating routine patient intake and triage' },
              { stat: '19%', label: 'Reduction in patient interaction time from first contact to confirmed appointment' },
            ].map(({ stat, label }) => (
        ...
        <div className="cs-section" style={{ marginBottom: '6rem' }}>
          ...
          <div style={{ marginTop: '2.5rem', background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.2)', borderRadius: '12px', padding: '2rem', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: '1.5rem', maxWidth: '480px', margin: '0 auto 1.5rem' }}>
              The full 60+ screen prototype covers every flow: conversational onboarding, symptom triage, provider matching, insurance verification, and appointment booking.
            </p>
            <a
              href={FIGMA_PROTOTYPE}
              target="_blank"
