  ...
  const cards = [
    {
      ...
      label: 'View Takeoff.ai case study',
      wireframe: <WireframeDashboard />,
      title: 'Takeoff.ai',
      desc: 'AI-powered construction estimator — conceived, designed, and shipped solo in 4 weeks.',
      tags: ['AI', 'Founder', 'Full-Stack', 'SaaS'],
    },
    {
      id: 'nttdata',
      onClick: onShowNTTData,
      label: 'View NTT Data case study',
      wireframe: <WireframeHealthcareAgent />,
      title: 'Healio — NTT Data',
      desc: 'Replaced 5 fragmented healthcare portals with one AI conversation. 50+ screens of agentic UX.',
      tags: ['AI Agent', 'Healthcare', 'Enterprise'],
    },
    {
      id: 'pg',
      onClick: onShowPG,
      label: 'View P&G Olay case study',
      wireframe: <WireframeEcommerce />,
      title: 'Procter & Gamble',
      desc: '7.6% checkout conversion lift and $100K+/month revenue contribution at P&G digital commerce.',
      tags: ['Enterprise', 'UX Research'],
    },
    {
      id: 'cc',
      onClick: onShowCC,
      label: 'View Credit Connection case study',
      wireframe: <WireframeMobileApp />,
      title: 'Credit Connection',
      desc: 'Fintech mobile app for credit building and financial access in underserved communities — 0 to shipped.',
      tags: ['Fintech', 'Mobile'],
    },
    {
      id: 'aiportfolio',
      onClick: onShowAIPortfolio,
      label: 'View AI Portfolio Build case study',
      wireframe: <WireframeAgentBuild />,
      title: 'AI Agent Build Process',
      desc: 'How I built this portfolio using an AI agent team — design intent to production with zero human handoffs.',
      tags: ['AI Agents', 'Meta'],
    },
  ]
